...
function check_door(userCoor) {
    ...
    if ((uZ < lDoorFront["ld"]["z"]  && uZ > lDoorFront["rd"]["z"]) ||
        ...
        invalidMove = 0;
    } else if (((uZ < rDoorFront["ld"]["z"]  && uZ > rDoorFront["rd"]["z"])) &&
        (uX > rDoorFront["ld"]["x"]-0.1 && uX < rDoorFront["ld"]["x"]+0.1)) { //Big right door
        invalidMove = 0;
    } else {
            invalidMove = 1;
    }
...
function check_move(userCoor, room, museumFlag) {
    ...
    var rZ1 = room["ld"]["z"] - 0.2;
    var rZ2 = room["rd"]["z"] + 0.2;
    //Ground Coordinates
    ...
    var bZ1 = chamber1["ld"]["z"] + 0.15;
    var bZ2 = chamber8["ru"]["z"] - 0.15;
...
function check_painting(room, roomCoor, userCoor) {
    /*
    Return the information about a painting inside a room
     */
    var uX = userCoor[0];
    ...
    switch (room) {
        case 0:
            console.log("Go inside Museum for information about paintings");
            break;
        case 1:
