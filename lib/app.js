...
function computeMatrices() {
    ...
    _.forEach(sceneObjects, (elem, index) => {
        ...
        elem.setLightDirection(lightDirection);
        elem.setLightPosition(lightPosition);
...
function drawScene() {
    ...
    _.forEach(sceneObjects, (elem) => {
        ...
        gl.uniform4f(lightColorHandle, lightColor[0], lightColor[1], lightColor[2], lightColor[3]);
