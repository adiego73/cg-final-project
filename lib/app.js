...
// LookAt camera matrix procedure, with the correct up-vector.
    var view = utils.MakeView(camx, camy, camz, 0, cardir);
...
function drawScene() {
    ...
    worldMatrix = utils.multiplyMatrices(worldMatrix, utils.MakeScaleMatrix(1.0));
...
//			angle     = psi/Math.PI*180;
    ...
    // car motion
    delta = utils.multiplyMatrixVector(worldMatrix, [0, 0, carLinVel, 0.0]);
    carX -= delta[0];
    carZ -= delta[2];
